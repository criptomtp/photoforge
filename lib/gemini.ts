...
const BG_RULE_LIFESTYLE = `— РЕАЛЬНА СЦЕНА: реалістичне середовище з глибиною кадру, доречне сезону й товару (вулиця, інтер'єр, природа, урбаністика), з природним об'ємом і легким боке. БЕЗ порожнього білого фону. Без сторонніх людей, тексту, водяних знаків, чужих брендів. Товар-герой завжди в чіткому фокусі й головний.
        ...
        parts: [
          ...imageParts,
          {
            text:
              ...
              genderLine +
              (season
                ? `Фон: LIFESTYLE-сцена. Сезон: ${season} — покажи товар у відповідній сезонній сцені (саме в цьому сезоні).\n`
