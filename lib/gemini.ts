...
ОБОВ'ЯЗКОВО ЗМІНИ (це має бути ВИДИМО ІНШИЙ кадр, а не копія еталона):
— Ракурс і положення камери згідно з описом нижче (повний зріст спереду / 3/4 з поворотом тіла на ~45° / строго збоку (профіль) / ззаду / великий план деталі тощо). Відчутно поверни тіло й зміни кадрування відповідно до ракурсу. Це та сама людина в тому самому образі та сцені, але АБСОЛЮТНО інший ракурс зйомки.
