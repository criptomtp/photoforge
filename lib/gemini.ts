...
— ПЕРШЕ зображення — ЕТАЛОН НАШОЇ МОДЕЛІ (кадр із цього ж фотосету). Відтвори ту саму людину: її обличчя, риси й форму обличчя, відтінок шкіри, бороду (якщо є), статуру, колір і довжину волосся, зачіску — і ОСОБЛИВО ТЕКСТУРУ ВОЛОССЯ (пряме / хвилясте / кучеряве — РІВНО як на еталоні). Це ОДНА Й ТА САМА людина: опис моделі в промпті (character sheet) і це еталонне фото описують ОДНУ Й ТУ САМУ особу — спирайся на ОБИДВА сигнали разом, вони доповнюють один одного. КАТЕГОРИЧНО НЕ копіюй із цього зображення позу, поворот тіла, ракурс камери, кадрування, фон, сцену, освітлення чи одяг — усе це НЕ звідси.
