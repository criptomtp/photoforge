...
— ПЕРШЕ зображення — ЕТАЛОН НАШОЇ МОДЕЛІ (кадр із цього ж фотосету) і ЄДИНЕ АВТОРИТЕТНЕ ДЖЕРЕЛО ЗОВНІШНОСТІ. Точно відтвори ту саму людину: її обличчя, риси й форму обличчя, відтінок шкіри, бороду (якщо є), статуру — і ОСОБЛИВО ВОЛОССЯ: його ТЕКСТУРУ (пряме / хвилясте / кучеряве — РІВНО як на еталоні), довжину, колір і зачіску. Це ОДНА Й ТА САМА реальна людина на всіх кадрах серії. ЯКЩО текст промпту описує зовнішність (надто волосся) інакше, ніж фото-еталон — ІГНОРУЙ текст щодо зовнішності: перемагає фото-еталон. КАТЕГОРИЧНО НЕ копіюй із цього зображення позу, поворот тіла, ракурс камери, кадрування, фон, сцену, освітлення чи одяг — усе це НЕ звідси.
— РЕШТА зображень — ЕТАЛОН ТОВАРУ-ГЕРОЯ {PRODUCT}. Візьми з них ВИКЛЮЧНО сам товар: крій, колір і відтінок, текстуру, матеріал, шви, фурнітуру, принти, логотипи. ⚠️ КРИТИЧНО: на цих фото-товарах може бути ЗОВСІМ ІНША людина (оригінальна модель продавця) — її обличчя, волосся й зовнішність ПОВНІСТЮ ІГНОРУЙ, це НЕ наша модель. Наша модель присутня ВИКЛЮЧНО на ПЕРШОМУ зображенні; обличчя, риси, волосся й статуру бери ЛИШЕ звідти, НІКОЛИ з фото-товару. НЕ переноси з фото-товару фон, реквізит, чужі речі чи людину.
